...
class LightweightModel(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.depthwise_conv = nn.Conv2d(in_channels, out_channels, kernel_size=3, padding=1, groups=in_channels)
...
class InteractSSM(nn.Module):
    ...
    def forward(self, x, **kwargs):
        ...
        y1, y2, y3, y4 = self.forward_core(x2)
